...
bool DBusClient::SubscribeSignal(const std::string &service_name, const std::string &object_path,
...
bool DBusClient::UnSubscribeSignal(const std::string &service_name, const std::string &object_path,
                                   const std::string &interface_name, const std::string &signal_name) {
  std::string signal_id = service_name + object_path + interface_name + signal_name;
