...
class DBusClient {
 ...
 public:
  ...
  bool CallMethod(const std::string &service_name, const std::string &object_path, const std::string &interface_name,
                  const std::string &method_name, _Args &&...args) {
    try {
  ...
  T CallMethod(const std::string &service_name, const std::string &object_path, const std::string &interface_name,
               const std::string &method_name, Args &&...args) {
    T result;
    try {
      auto proxy = sdbus::createProxy(*connection_, service_name, object_path);
      proxy->callMethod(method_name)
  ...
  template <typename... _Args>
  bool EmitSignal(const std::string &object_path, const std::string &interface_name, const std::string &signal_name,
                  _Args &&...args) {
  ...
  bool SubscribeSignal(const std::string &service_name, const std::string &object_path, const std::string &interface_name,
                       const std::string &signal_name, const sdbus::signal_handler &handler);

  bool UnSubscribeSignal(const std::string &service_name, const std::string &object_path, const std::string &interface_name,
...
bool CallMethod(const std::string &service_name, const std::string &object_path, const std::string &interface_name,
                const std::string &methd_name, Args &&...args) {
  DBusClient client;
...
T CallMethod(const std::string &service_name, const std::string &object_path, const std::string &interface_name,
             const std::string &methd_name, Args &&...args) {
  DBusClient client;
  return client.CallMethod<T, Args...>(service_name, object_path, interface_name, methd_name, std::forward<Args>(args)...);
}
